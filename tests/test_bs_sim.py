...
class TestBS(unittest.TestCase):
    ...
    def test_batt_installed_power(self):
        ...
        timeseries = batt.simulate(control_type="installed_power",
                                   p_kw=test_data)
        p_after_result = [
            0., -3., -2., 3., 3., 3., 3., 3., 3., 3., 3., 3., 3., 3., 3., 3.,
            3.
        ]
        var_bat_result = [
            10., 10., 10., 8.75, 7.75, 7., 6., 4.75, 4.75, 4.25, 4., 5.25, 6.,
            6.25, 7., 7.75, 8.5
        ]
    ...
    def test_batt_production_saving(self):
        ...
        timeseries = batt.simulate(control_type="production_saving",
                                   p_kw=test_data)
        p_after_result = [
            0., -3., -2., 3., 2., 1., 2., 3., 0., 0., 0., 0., 0., 0., 0., 0.,
            0.
        ]
        var_bat_result = [
            10., 10., 10., 8.75, 7.5, 6.25, 5., 3.75, 3., 1.75, 0.75, 1.25,
